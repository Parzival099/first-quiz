...
WHERE EXISTS (
    ...
    WHERE people_animals.pet_id = animals.animal_id AND animals.age > people.age
);
...
AND NOT EXISTS (
    ...
    WHERE pa2.pet_id = people_animals.pet_id
    AND pa2.owner_id <> people_animals.owner_id
);
